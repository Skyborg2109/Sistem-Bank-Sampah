<?php $__env->startSection('title', 'Kelola Data Sampah'); ?>
...
<div class="animate-slide-in">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $sampah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($item->jenis_sampah); ?></div>
                                        <div class="text-xs text-gray-500">ID: #<?php echo e(str_pad($item->id, 4, '0', STR_PAD_LEFT)); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <a href="/Admin/data-sampah/edit/<?php echo e($item->id); ?>" 
                                    ...
                                    <form action="/Admin/data-sampah/delete/<?php echo e($item->id); ?>" 
                                          method="POST" 
                                          class="inline-block"
        ...
        <?php if($sampah->count() > 0): ?>
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    <div class="flex items-center space-x-2">
                        <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                        <span class="text-sm text-gray-600">Total Data: <span class="font-semibold text-gray-900"><?php echo e($sampah->count()); ?></span></span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="w-2 h-2 bg-indigo-500 rounded-full"></div>
                        <span class="text-sm text-gray-600">Total Berat: <span class="font-semibold text-gray-900"><?php echo e(number_format($sampah->sum('berat'), 2)); ?> Kg</span></span>
                    </div>
                </div>
                <div class="text-sm text-gray-500">
                    Menampilkan <?php echo e($sampah->count()); ?> data
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SistemMhs_BankSampah\resources\views/admin/datasampah/dataSampah.blade.php ENDPATH**/ ?>