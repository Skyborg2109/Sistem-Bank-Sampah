...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Warga'); ?> - Bank Sampah</title>
    ...
    <div class="header-right">
        ...
        <div class="dropdown">
            <div class="user-profile" id="profileBtn">
                <?php echo e(strtoupper(substr(session('username', 'W'), 0, 1))); ?>

            </div>
            
            <div class="dropdown-menu" id="profileMenu">
                <div class="dropdown-header">
                    <?php echo e(session('username', 'Warga')); ?>
...
<div class="main-layout">
    ...
    <aside class="sidebar">
        <ul class="sidebar-menu">
            <li>
                <a href="/Warga" class="<?php echo e(request()->is('Warga') || request()->is('warga/dashboard') ? 'active' : ''); ?>" title="Home">
                    ⌂
                </a>
            </li>
            <li>
                <a href="/warga/laporan" class="<?php echo e(request()->is('warga/laporan*') ? 'active' : ''); ?>" title="Laporan">
                    ♻
                </a>
            </li>
        </ul>
...
<?php /**PATH C:\laragon\www\SistemMhs_BankSampah\resources\views/layouts/warga.blade.php ENDPATH**/ ?>