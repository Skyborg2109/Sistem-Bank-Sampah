<!DOCTYPE html>
<html lang="id" class="<?php echo e(($userSettings->dark_mode ?? false) ? 'dark' : ''); ?>">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="<?php echo e(asset('images/logo.png')); ?>" type="image/x-icon">
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - Bank Sampah</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="sidebar fixed h-full bg-white shadow-xl flex flex-col items-center py-6 z-50" id="sidebar">
        ...
        <nav class="flex-1 flex flex-col items-center space-y-4 w-full px-3">
            ...
            <a href="/Admin/dashboard" class="nav-icon p-3 rounded-xl <?php echo e(request()->is('Admin/dashboard') ? 'bg-gradient-to-br from-purple-500 to-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'); ?> flex items-center w-full">
            ...
            <a href="/Admin/dataPengguna" class="nav-icon p-3 rounded-xl <?php echo e(request()->is('Admin/dataPengguna*') ? 'bg-gradient-to-br from-purple-500 to-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'); ?> flex items-center w-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 flex-shrink-0">
            ...
            <a href="/Admin/data-sampah" class="nav-icon p-3 rounded-xl <?php echo e(request()->is('Admin/data-sampah*') ? 'bg-gradient-to-br from-purple-500 to-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'); ?> flex items-center w-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 flex-shrink-0">
            ...
            <a href="/Admin/laporan" class="nav-icon p-3 rounded-xl <?php echo e(request()->is('Admin/laporan*') ? 'bg-gradient-to-br from-purple-500 to-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'); ?> flex items-center w-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 flex-shrink-0">
        ...
        <header class="topbar sticky top-0 z-40 px-8 py-4 shadow-sm border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4 flex-1">
                    <?php echo $__env->yieldContent('topbar-left'); ?>
                </div>
                    ...
                    <div class="dropdown">
                        <button id="profileBtn" class="flex items-center space-x-3 px-3 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                            <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                <?php echo e(strtoupper(substr(session('username', 'A'), 0, 1))); ?>

                            </div>
                            <div class="hidden md:block">
                                <p class="text-sm font-semibold text-gray-800"><?php echo e(session('username', 'Admin')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(ucfirst(session('role', 'admin'))); ?></p>
                            </div>
                        ...
                        <div id="profileMenu" class="dropdown-menu" style="min-width: 16rem;">
                            <div class="p-4 border-b border-gray-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e(session('username', 'Admin')); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e(session('role', 'admin')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="py-2">
...
<?php /**PATH C:\laragon\www\SistemMhs_BankSampah\resources\views/layouts/admin.blade.php ENDPATH**/ ?>