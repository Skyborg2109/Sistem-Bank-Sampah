                        ...
                        <tr class="table-row">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                        <?php echo e(strtoupper(substr($user->nama_user, 0, 2))); ?>

                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($user->nama_user); ?></div>
                                        <div class="text-xs text-gray-500">ID: #<?php echo e(str_pad($user->id, 4, '0', STR_PAD_LEFT)); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-900"><?php echo e($user->username); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php
                                ...
                                ?>
                                <span class="px-3 py-1 inline-flex items-center text-xs leading-5 font-semibold rounded-full <?php echo e($roleClass); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3 h-3 mr-1">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($roleIcon); ?>" />
                                    </svg>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <a href="/Admin/dataPengguna/edit/<?php echo e($user->id); ?>" 
                                    ...
                                    <form action="/Admin/dataPengguna/delete/<?php echo e($user->id); ?>" 
                                          method="POST" 
                                          class="inline-block"
                                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna <?php echo e($user->nama_user); ?>?')">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" 
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm text-gray-600">Total Pengguna: <span class="font-semibold text-gray-900"><?php echo e($users->count()); ?></span></span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span class="text-sm text-gray-600">Admin: <span class="font-semibold text-gray-900"><?php echo e($users->where('role', 'admin')->count()); ?></span></span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span class="text-sm text-gray-600">Petugas: <span class="font-semibold text-gray-900"><?php echo e($users->where('role', 'petugas')->count()); ?></span></span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                        <span class="text-sm text-gray-600">Warga: <span class="font-semibold text-gray-900"><?php echo e($users->where('role', 'warga')->count()); ?></span></span>
                    </div>
                </div>
                <div class="text-sm text-gray-500">
                    Menampilkan <?php echo e($users->count()); ?> pengguna
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<script>
    ...
    function updateEmptyState(visibleCount) {
        ...
        const hasData = <?php echo e($users->count() > 0 ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SistemMhs_BankSampah\resources\views/admin/dataPengguna/dataPengguna.blade.php ENDPATH**/ ?>