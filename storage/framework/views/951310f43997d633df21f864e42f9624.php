...
<?php $__env->startSection('title', 'Tambah Data Sampah'); ?>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select 
                        ...
                        <option value="Plastik" <?php echo e(old('jenis_sampah') == 'Plastik' ? 'selected' : ''); ?>>Plastik</option>
                        <option value="Kertas" <?php echo e(old('jenis_sampah') == 'Kertas' ? 'selected' : ''); ?>>Kertas</option>
                        <option value="Logam" <?php echo e(old('jenis_sampah') == 'Logam' ? 'selected' : ''); ?>>Logam</option>
                        <option value="Kaca" <?php echo e(old('jenis_sampah') == 'Kaca' ? 'selected' : ''); ?>>Kaca</option>
                        <option value="Organik" <?php echo e(old('jenis_sampah') == 'Organik' ? 'selected' : ''); ?>>Organik</option>
                        <option value="Elektronik" <?php echo e(old('jenis_sampah') == 'Elektronik' ? 'selected' : ''); ?>>Elektronik</option>
                        <option value="Lainnya" <?php echo e(old('jenis_sampah') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                    </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SistemMhs_BankSampah\resources\views/admin/datasampah/dataSampahTambah.blade.php ENDPATH**/ ?>