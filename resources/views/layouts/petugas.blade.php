...
<head>
    ...
    <title>@yield('title', 'Dashboard Petugas') - Bank Sampah</title>
    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1 px-2">
                <li>
                    <a href="/petugas" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->is('petugas') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                ...
                <li>
                    <a href="/petugas/datasampah" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg {{ request()->is('petugas/datasampah*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="p-4 border-t border-gray-200">
            <div class="flex items-center space-x-3">
                <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold">
                    {{ strtoupper(substr(session('username', 'P'), 0, 1)) }}
                </div>
                <div>
                    <div class="text-sm font-medium text-gray-900">{{ session('username', 'Petugas') }}</div>
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
            <div class="flex items-center">
               <h1 class="text-xl font-semibold text-gray-800">
                   @yield('header', 'Dashboard Petugas')
               </h1>
            </div>
